<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="Transport_rx" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.Transport_rx = echarts.init(document.getElementById(id))
        this.Transport_rx.setOption({
        title: {
            text: 'Transport rx'
        },
        tooltip: {
