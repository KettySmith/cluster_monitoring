<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="GC_runtime" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.GC_runtime = echarts.init(document.getElementById(id))
        this.GC_runtime.setOption({
        title: {
            text: 'GC Runtime'
        },
        tooltip: {
