<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="Os_load" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.Os_load = echarts.init(document.getElementById(id))
        this.Os_load.setOption({
        title: {
            text: 'OS Load'
        },
        tooltip: {
