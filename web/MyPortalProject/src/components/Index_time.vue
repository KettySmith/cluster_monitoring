<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="Index_time" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.Index_time = echarts.init(document.getElementById(id))
        this.Index_time.setOption({
        title: {
            text: 'Index Time'
        },
        tooltip: {
