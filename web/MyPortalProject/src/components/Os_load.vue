<template>
  <div class="chart" style="display: flex;">
    <div style="width:80%;">
      <div v-if="data_show" id="Os_load" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
...
export default {
  ...
  methods: {
    ...
    node_query() {
      ...
      axios.post('http://127.0.0.1:8090/show/get_node_single_data/' + this.cluster_name + '/elasticsearch_os_load5',
        params, {
