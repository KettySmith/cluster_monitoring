<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="Query_time" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.Query_time = echarts.init(document.getElementById(id))
        this.Query_time.setOption({
        title: {
            text: 'Query Time'
        },
        tooltip: {
