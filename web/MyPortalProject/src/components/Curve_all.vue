    ...
    <div class="chart">
        ...
        <div style="width:100%;height: 520px;">
            <div v-if="Curve_data_show" id="Curve_all"
                style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px;"></div>
            <div v-else
                style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px;box-shadow: 0 2px 4px rgba(0, 0, 0, .4);display: flex;justify-content: center;align-items: center;">
