<template>
    <div class="chart" style="display: flex;">
      <div style="width:80%;">
        <div id="Fs_available" style="width: 100%;height: 520px;margin-top: 50px;margin-bottom: 50px"></div>
      </div> 
...
export default {
  ...
  methods: {
    drawLine(id) {
        this.Fs_available = echarts.init(document.getElementById(id))
        this.Fs_available.setOption({
        title: {
            text: 'Filesystem Available'
        },
        tooltip: {
            trigger: 'axis'
        },
